...
public class SmsDemo {
	...
	static final String accessKeyId = "RizlE72aceNSAgDn";
	static final String accessKeySecret = "srOlc4XXBWyJ64sAti88sfiSkRcZkd";
	...
	public static boolean sendSms(String phone,String code) throws ClientException {
		...
		try {
			...
			// 必填:短信签名-可在短信控制台中找到
			request.setSignName("币大师");
			// 必填:短信模板-可在短信控制台中找到
			request.setTemplateCode("SMS_86680152");
			...
			return sendSmsResponse.getCode().equalsIgnoreCase("OK");
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(sendSms("18337816380","1234"));
		
		// // 发短信
		// SendSmsResponse response = sendSms("13122869919");
