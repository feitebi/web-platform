...
/**
 * Modified the code to avoid set NULL to any field.
 * 
 * @author mac
 */
public class NoNullBeanProcessor {

    /**
     * Special array value used by <code>mapColumnsToProperties</code> that
     * indicates there is no bean property that matches a column from a <code>ResultSet</code>.
     */
     ...
     * @since 1.5
     */
    public NoNullBeanProcessor(Map<String, String> columnToPropertyOverrides) {
        super();
    ...
    private void callSetter(Object target, PropertyDescriptor prop, Object value) throws SQLException {
        ...
        try {
            ...
            // =========Add NULL checking for ignoring to set null to any field======================

            // Don't call setter if the value object isn't the right type
            if (this.isCompatibleType(value, params[0]) && value != null) {
     ...
     * stored at each position represent the index in the <code>PropertyDescriptor[]</code> for the bean property that
     * matches the
